...
public class EmpManagementClient {
    ...
    private static void saveBankAccountDetails(){
        BankAccount acc = new BankAccount(20000,"Susmitha Sanikommu","ASD1234ERT");
        employeeController.saveBankAccountDetails(acc);
    }
