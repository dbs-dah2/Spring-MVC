...
public class EmpManagementClient {
    ...
    private static void saveEmployees(){
        ...
        employee.getDependents(employee.getId());
        
        employee = new Employee("Harish Kalyan", LocalDate.of(1978,3, 15), "ACCOUNT");
        Dependent dependent5 = new Dependent();
        dependent5.setName("SRK");
        dependent5.setAge(41);
        Dependent dependent6 = new Dependent();
        dependent6.setName("SSR");
        dependent6.setAge(29);
        employee.addDependent(dependent5);
        employee.addDependent(dependent6);
        employeeController.saveEmployee(employee);
        employee.getDependents(employee.getId());
