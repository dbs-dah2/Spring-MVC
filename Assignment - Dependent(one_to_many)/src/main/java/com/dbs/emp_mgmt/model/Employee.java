...
//    private Set<BankAccount> bankAccountSet;
    ...
    public void getDependents(long emp_id){
    	Set<Dependent> dependentSet1 = new HashSet<>(dependentSet);
    	dependentSet1.addAll(dependentSet);
    	System.out.println();
    	System.out.println("                         Dependents for Employee id : " + emp_id);
    	for(Dependent dependent:dependentSet1) {
    		System.out.println("-------------------------------");
    		System.out.println("Dependent Id : " + dependent.getId());
    		System.out.println("Dependent Age : " + dependent.getAge());
